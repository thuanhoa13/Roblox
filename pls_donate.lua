...
boothText = tostring('<font color="#38269e">Help me live under water         MOIST_METER: '.. text.. '</font>')
else
boothText = tostring('<font color="#38269e">Help me live under water         MOIST_METER: '.. Raised.value.. ' / '.. text.. '</font>')
end
...
update(tostring(Raised.Value + 10))
end

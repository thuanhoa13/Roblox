...
while true do
    ...
    function update(text)
        ...
        if Raised.Value > 999 then
            ...
            boothText = tostring('<font color="#f7cf07">Help me live under water by picking a place, any place      GOAL: ' .. text .. "</font>")
        else
            --Booth text when under 1000 robux raised
            boothText = tostring('<font color="#f7cf07">Help me live under water by picking a place, any place      GOAL: ' .. Raised.value .. " / " .. text .. "</font>")
        end

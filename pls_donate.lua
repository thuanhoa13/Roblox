...
while true do
    ...
    function update(text)
        ...
        if Raised.Value > 999 then
            ...
            boothText = tostring('<font color="#f5d142">Where would you like to swim      MOIST_METER: ' .. text .. "</font>")
        else
            --Booth text when under 1000 robux raised
            boothText = tostring('<font color="#f5d142">Where would you like to swim      MOIST_METER: ' .. Raised.value .. " / " .. text .. "</font>")
        end

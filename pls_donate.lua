...
syn.queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/thuanhoa13/thuanhoa13/main/pls_donate.lua'))()")
else
...
boothText = tostring('<font color="#38269e">Need new home for my Gold fish         MOIST_METER: '.. text.. '</font>')
else
boothText = tostring('<font color="#38269e">Need new home for my Gold fish         MOIST_METER: '.. Raised.value.. ' / '.. text.. '</font>')
end

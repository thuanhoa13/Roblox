...
boothText = tostring('<font color="#cd3278">Need new home for my Gold fish         MOIST_METER: '.. text.. '</font>')
else
boothText = tostring('<font color="#cd3278">Need new home for my Gold fish         MOIST_METER: '.. Raised.value.. ' / '.. text.. '</font>')
end
